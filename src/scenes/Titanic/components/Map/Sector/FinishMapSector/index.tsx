import { BottomLeftSector, BottomRightSector, ElementIcon, IconCount, IconCounter, RegularSector, SmallElemetIcon, TopLeftSector, TopRightSector } from './FinishMapSector.style'
...
export default function FinishMapSector({hasIceberg, index, number}: sectorProps){
