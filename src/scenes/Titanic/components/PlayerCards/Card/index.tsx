...
import { IcebergCard, Nickname, TitanicCard, Titanic, AvatarDiv, Ships, Icebergs, Icon, AvatarAndName, IcebergCount, TitanicText, IcebergText } from "./Card.style";
...
export default function Card({avatarSeed, nickname, titanic, hits, icebergsHaveAppeared, status}:CardProps){
