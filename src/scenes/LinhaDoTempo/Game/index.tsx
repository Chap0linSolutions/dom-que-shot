...
import { Content, Game, PhraseDiv, Banner, BannerBeer, Text, Phrase, Line, InputDiv, Input, GuidanceText, Decoration, Dot } from "./Game.style";
...
export default function GamePage({question, timeLeft, turnVisibility, sendGuess}: GameProps){
        ...
        <Background noImage>
            ...
            <Game>
                ...
                <Banner ref={bannerRef}>
                    ...
                    <Text>
                        {(guess === Status.TIMESUP)? <>Tempo esgotado!</> : <>Resposta enviada!</>}
                        <br />
                        Aguardando...
                    </Text>
                </Banner>
