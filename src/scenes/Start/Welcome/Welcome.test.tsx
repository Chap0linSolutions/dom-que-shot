...
describe('Welcome page', () => {
  it('Renders the page correctly', () => {
    const { getByText } = render(<Welcome navigate={mockNavigate} setRoom={mockSetRoom} setPage={mockSetPage} />);
  ...
  it('Should not show options from Menu without click on it', () => {
    const { queryByText } = render(<Welcome navigate={mockNavigate} setRoom={mockSetRoom} setPage={mockSetPage} />);
  ...
  it('Should show options from Menu when click on it', () => {
    const { getByText, getByTestId } = render(<Welcome navigate={mockNavigate} setRoom={mockSetRoom} setPage={mockSetPage} />);
  ...
  it('Should render the logo image', () => {
    const { getByAltText } = render(<Welcome navigate={mockNavigate} setRoom={mockSetRoom} setPage={mockSetPage} />);
